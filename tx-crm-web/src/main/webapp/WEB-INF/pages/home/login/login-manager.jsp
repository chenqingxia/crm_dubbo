	...
	<div class="content">
        ...
        <div class="loginCon w1200">
            <form action="" id="loginform" class="transparent-white">
                ...
                <p><button type="button" class="loginBtn loginBtn01" onclick="window.location.href='/module/account'">进入账户中心</button></p>
                <c:if test="${!empty userflag && userflag== 1}"><p><button type="button" class="loginBtn loginBtn02" onclick="window.location.href='/module/card'">寄售充值卡</button></p></c:if>
            </form>
        </div> <!-- end loginCon -->
